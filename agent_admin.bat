...
REM ============================================================
REM WinRemote Agent V0.4.1 - Windows 本机服务管理工具
...
echo.
echo ╔══════════════════════════════════════════╗
echo ║   WinRemote Agent V0.4.1 服务管理工具       ║
echo ╚══════════════════════════════════════════╝
echo.
...
nssm set WinRemoteAgent DisplayName "WinRemote Agent V0.4.1" || goto :install_fail
